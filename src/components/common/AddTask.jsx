      ...
      >
        <div>
          ...
          <input
            ...
            id="title"
            className="input input-lg text-base w-full focus:outline-none focus:border-indigo-500"
            value={title}
        ...
        <div>
          ...
          <textarea
            ...
            id="description"
            className="textarea text-base w-full focus:outline-none focus:border-indigo-500"
            value={description}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              className="select select-lg w-full focus:outline-none focus:border-indigo-500"
            >
        ...
        <div>
          <button
            className="btn btn-lg btn-primary text-white font-semibold mt-2 w-full shadow-none"
            type="submit"
          >
            Add New Task
          </button>
